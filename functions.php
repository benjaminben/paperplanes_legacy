<?php
/**
 * Paper Planes functions and definitions
 *
...
if ( ! function_exists( 'paperplanes_setup' ) ) :
	/**
	 ...
	 */
	function paperplanes_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Paper Planes, use a find and replace
		 * to change 'paperplanes' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'paperplanes', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'paperplanes' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'paperplanes_custom_background_args', array(
...
add_action( 'after_setup_theme', 'paperplanes_setup' );
 ...
 */
function paperplanes_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'paperplanes_content_width', 640 );
}
add_action( 'after_setup_theme', 'paperplanes_content_width', 0 );
 ...
 */
function paperplanes_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'paperplanes' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'paperplanes' ),
...
add_action( 'widgets_init', 'paperplanes_widgets_init' );
...
function paperplanes_scripts() {
  ...
  wp_enqueue_script( 'gsap-tweenmax', get_template_directory_uri() . '/js/gsap/minified/TweenMax.min.js', array(), '20151215', false );
	wp_enqueue_script( 'barbajs', 'https://cdnjs.cloudflare.com/ajax/libs/barba.js/1.0.0/barba.min.js', array('gsap-tweenmax'), null, true );
	wp_enqueue_script( 'paperplanes-main', get_template_directory_uri() . '/js/main.js', array('vuejs'), '20151215', true );
	wp_enqueue_script( 'paperplanes-loader', get_template_directory_uri() . '/js/loader.js', array('gsap-timelinemax','paperplanes-main'), '20151215', true );
